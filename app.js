...
const employees = [
    new WageEmployee_1.WageEmployee(123, "Vasya", 1970, "Development", 10000, 100, 100),
    new WageEmployee_1.WageEmployee(124, "Sara", 1975, "Management", 12000, 100, 100),
    new SalesPerson_1.SalesPerson(125, "Abraham", 1980, "Sales", 11000, 100, 100, 10000, 1)
];
...
const empl2 = company.getEmployee(125); // empl2 is a type or Employee or NULL
// if (empl2) {
...
const salary2 = empl2.computeSalary(); // if NULL then exeption
